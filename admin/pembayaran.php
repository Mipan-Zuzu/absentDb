...
<!-- Modal macOS -->
<dialog id="modalPembayaran" class="modal">
  <div class="modal-box relative p-5">
    ...
    <p><strong>Pegawai:</strong> <span id="modalPegawai"></span></p>
...
<script>
function openDetail(nama, tanggal, bulan, nominal, metode, pegawai, id) {
    document.getElementById('modalNama').textContent = nama;
    document.getElementById('modalTanggal').textContent = tanggal;
    document.getElementById('modalBulan').textContent = bulan;
    document.getElementById('modalNominal').textContent = nominal;
    document.getElementById('modalMetode').textContent = metode;
    document.getElementById('modalPegawai').textContent = pegawai;

    const modalActions = document.getElementById('modalActions');
    modalActions.innerHTML = `
      <a href="pembayaran_edit.php?id=${id}" class="btn btn-warning">Edit</a>
      <a href="pembayaran_hapus.php?id=${id}" class="btn btn-error"
    ...
    document.getElementById('modalPembayaran').showModal();
}
</script>
