...
if (isset($_GET['cari']) && $_GET['cari'] != "") {
    ...
    $result = mysqli_query($koneksi, "SELECT * FROM guru WHERE nama_guru LIKE '%$cari%' ORDER BY id_guru DESC");
} else {
    $result = mysqli_query($koneksi, "SELECT * FROM guru ORDER BY id_guru DESC");
}
?>

<div class="container mt-2 main-content-jurusan">
    <?php if (isset($_GET['pesan'])): ?>
        <div class="alert alert-success alert-dismissible fade show">
            ...
            if ($_GET['pesan'] == 'edit')
                echo "✅ Data guru berhasil diperbaharui!";
            if ($_GET['pesan'] == 'hapus')
    ...
    <div class="flex justify-end mb-3 flex-wrap gap-2 mt-5">
...
<!-- Modal Dialog Guru ala macOS -->
<dialog id="my_modal_1" class="modal">
  <div class="modal-box relative p-5">
    <!-- Traffic light macOS -->
    <div class="absolute mb-5 top-2 left-3 flex space-x-2">
    ...
    <p class="py-2"><strong>Tanggal Lahir:</strong> <span id="modalTglLahir"></span></p>
    <p class="py-2"><strong>Alamat:</strong> <span id="modalAlamat"></span></p>
    <p class="py-2"><strong>Telp:</strong> <span id="modalTelp"></span></p>
    <p class="py-2"><strong>Username:</strong> <span id="modalUsername"></span></p>
...
<script>
function openDetail(nama, tgl, alamat, telp, username, id) {
    document.getElementById('modalNama').textContent = nama;
    document.getElementById('modalTglLahir').textContent = tgl;
    ...
    modalActions.innerHTML = `
      <a href="guru_edit.php?id=${id}" class="btn btn-warning">Edit</a>
      <a href="guru_hapus.php?id=${id}" class="btn btn-error"
