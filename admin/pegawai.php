...
<!-- Modal Dialog Pegawai ala macOS -->
<dialog id="my_modal_1" class="modal">
  <div class="modal-box relative p-5">
    ...
    <!-- Konten Modal -->
    <h3 class="text-lg font-bold mt-3" id="modalNama">Nama Pegawai</h3>
...
function openDetail(nama, tgl, alamat, telp, username, id) {
    ...
    modalActions.innerHTML = `
      <a href="pegawai_edit.php?id=${id}" class="btn btn-warning">Edit</a>
      <a href="pegawai_hapus.php?id=${id}" class="btn btn-error"
