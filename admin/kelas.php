...
<dialog id="my_modal_1" class="modal">
  <div class="modal-box relative p-5">
    ...
    <!-- Konten Modal -->
    <h3 class="text-lg font-bold mt-3" id="modalNama">Nama Kelas</h3>
    <p class="py-2"><strong>Jurusan:</strong> <span id="modalJurusan"></span></p>
    <p class="py-2"><strong>Guru:</strong> <span id="modalGuru"></span></p>
...
<script>
function openDetail(nama, jurusan, guru, id) {
    ...
    modalActions.innerHTML = `
      ...
      <a href="kelas_hapus.php?id=${id}" class="btn btn-error"
